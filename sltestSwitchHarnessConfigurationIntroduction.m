...
%%
% This example shows how to change between various harness settings
...
% This test harness has been created for prototyping by setting the *CreateWithoutCompile*
% parameter to *true* and the *SynchronizationMode* parameter to
% *Synchronize on harness open and close*. The harness has been generated
% without compiling the model, and is configured to synchronize changes
% between the main model and harness during harness open and close.  
...
% the model, update the the *Rebuild harness on open* setting in the dialog or enter:
